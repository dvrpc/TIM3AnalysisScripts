...
#base_path = r'D:\TIM3.1\CalibrationMarch2021\scenario\Output'
#base_path = r'Y:\TIM_3.1\DVRPC_ABM_Testing\scenario\Output'
#base_path = r'R:\Model_Development\TIM_3.1\scenario\Output'
#base_path = r'B:\model_development\TIM_3.1_Github - Copy\scenario\output\Coefficient_103'
#base_path = r'D:\TIM3.1\200630_NoTripDestParkingSensitivity\scenario\Output\10%'
#base_path = r'B:\model_development\TIM_3.1_Github - Copy\scenario\output\Time Utility+103'
#base_path = r'\\peach\Modeling\Model_Development\TIM_3.1\scenario\Output\Output_NMShare_0307'
base_path = r'\\peach\Modeling\Model_Development\TIM_3.1\scenario\Output\Output_Base_0303'
tables = {}
tables['hh'] = pd.read_csv(os.path.join(base_path, '_household_2.dat'), '\t').iloc[:-1]
...
outfile = os.path.join(r'D:\TIM3\ToFromCCModeTrips_PeachBase_Raw.xlsx')
