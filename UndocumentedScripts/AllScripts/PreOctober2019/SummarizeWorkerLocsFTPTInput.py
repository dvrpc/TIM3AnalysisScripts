...
for line in per:
    ...
    if first_line:
        ...
        if entry[pptyp] not in data.keys() or entry[wtaz] in ['-1', '0']:
            continue
        else:
            i += 1
        try:
...
outfile = {'1': r'D:\Debugging\WorkLocationFullTimeCountyFlowInput.csv',
           '2': r'D:\Debugging\WorkLocationPartTimeCountyFlowInput.csv'}
