...
infile = r'D:\TIM3\TransitTripsWithSubBusIVT.csv'
outfile = infile.replace('.csv', '_HalfMile.csv').replace('TIM3', 'TIM3\\TransitTrips')
...
trip = trip.query('opcl in @subway_mazs and dpcl in @subway_mazs')
