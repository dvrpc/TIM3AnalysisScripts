...
trip_file = r'T:\TIM_3.1\DVRPC_ABM_Testing\Scenario\Output\_trip_2.dat'
skim_loc = r'Y:\TIM_3.1\DVRPC_ABM_Testing\scenario'
outfile = r'D:\TIM3\TransitTripsWithSubBusIVT_No5.csv'
...
trip.to_csv(outfile.replace('.csv', 'NO_IVT.csv'))
