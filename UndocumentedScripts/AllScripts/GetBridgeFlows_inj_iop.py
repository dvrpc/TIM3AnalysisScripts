...
outfile = r'D:\TIM3\BridgeFlowsDaySurveyUnweighted_inj_iop.csv'

#Define OD sets
br_e =   [702, 701, 801, 802, 803, 703, 805, 704, 804] #1901
br_w =   [509, 401]#[109, 101, 107, 114, 115, 113, 103, 110] #509, 401
br_ew = setproduct(br_e, br_w)
bfww_e = [801, 804, 901, 803, 802, 702, 903, 906, 805] #2001
bfww_w = [203, 202, 401]#[103, 110, 112, 105, 102, 107, 101] #203, 202, 401
...
output['br_wb_tour_purp'] = br_wb_tour.groupby('pdpurp').count()['toexpfac']
output['br_eb_tour_purp'] = br_eb_tour.groupby('pdpurp').count()['toexpfac']
...
output['bfww_wb_tour_purp'] = bfww_wb_tour.groupby('pdpurp').count()['toexpfac']
output['bfww_eb_tour_purp'] = bfww_eb_tour.groupby('pdpurp').count()['toexpfac']
...
output['both_wb_tour_purp'] = both_wb_tour.groupby('pdpurp').count()['toexpfac']
output['both_eb_tour_purp'] = both_eb_tour.groupby('pdpurp').count()['toexpfac']
